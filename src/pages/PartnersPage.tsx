...
const partners = [
  {
    ...
    companies: [
      ...
      { 
        ...
        logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/3/31/Juniper_Networks_logo.svg/2560px-Juniper_Networks_logo.svg.png',
        description: 'High-performance networking products and solutions for enterprise networks and service providers.'
      },
      { 
        name: 'HP Aruba', 
        logo: 'https://cdn.1min30.com/wp-content/uploads/2018/07/Aruba-logo.jpg',
        description: 'Enterprise networking solutions focusing on wireless networks, security, and network management.'
      },
      { 
        name: 'TP-Link', 
        logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/09/TP-Link_logo.svg/2560px-TP-Link_logo.svg.png',
  ...
  },
  {
    ...
    companies: [
      { 
        name: 'Fortinet', 
        logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/Fortinet_logo.svg/2560px-Fortinet_logo.svg.png',
      ...
      { 
        name: 'Sophos', 
        logo: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Sophos_logo.svg/2560px-Sophos_logo.svg.png',
